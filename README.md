...
- **Scheda provider**: Torrentio, Knaben e SolidTorrents (aggregatori senza chiavi, includono ITA), **addon upstream personalizzati (Comet/MediaFusion già configurati)**, TorBox, Real-Debrid, Il Corsaro Nero/Viola, TNT Village, PirateBay, 1337x, EZTV, YTS, Jackett/Prowlarr.
